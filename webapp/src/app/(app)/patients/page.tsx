                        ...
                        <div className="space-y-1">
                          {patient.email && (
                            <div className="flex items-center gap-1">
                              ...
                              <a href={`mailto:${patient.email}`} className="text-xs text-indigo-600 hover:underline">
                                {patient.email}
                              </a>
                            </div>
                          )}
                          {patient.phone && (
                            <div className="flex items-center gap-2">
                              <div className="flex items-center gap-1">
                                ...
                                <a href={`tel:${patient.phone}`} className="text-xs text-indigo-600 hover:underline">
                                  {patient.phone}
                                </a>
                              </div>
                              <a
                                href={`https://wa.me/${patient.phone.replace(/[\s\-\(\)]/g, "")}`}
                                target="_blank"
